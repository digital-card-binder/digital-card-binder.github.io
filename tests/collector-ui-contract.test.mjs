...
test("dashboard and news page expose a quiet latest-news flow", async () => {
  ...
  assert.equal(newsData.items[0].id, "android-app-v09-update");
...
test("public profile summaries cache-bust the current catalog metrics", async () => {
  ...
  assert.match(profilePage, /collector-collection-registry[.]js[?]v=20260902-2/);
  assert.match(profilePage, /collector[.]js[?]v=20260813-4/);
  assert.match(directoryPage, /collector-collection-registry[.]js[?]v=20260902-2/);
